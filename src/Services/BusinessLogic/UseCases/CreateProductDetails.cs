...
namespace Services.Products.BusinessLogic.UseCases
{
    ...
    public class CreateProductDetails : ICreateProductDetails
    {
        ...
        public CreateProductDetails(IProductsWriteStore writeStore, IDomainMessagePublisher domainMessagePublisher, IStockApi stockApi, IWarehouseApi warehouseApi)
        {
        ...
        public async Task<CreateProductResponse> Execute(CreateProductRequest productRequest)
        {
            ...
            //string getUrl = await DiscoveryServices.Microservices.ProductsApi.ApiRead;
